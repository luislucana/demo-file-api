...
public class FileSplitterV1 {
    ...
    private static void copyBytesToPartFile(byte[] originalBytes, List<String> partFiles, int partNum, int bytesPerSplit, int bufferSize) throws IOException {
     ...
     * @throws IOException
     */
    public static List<String> splitFile(String fileName, int mBperSplit) throws IOException {
